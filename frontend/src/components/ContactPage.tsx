...
const ContactPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // =================================================================================
    // WICHTIG: Bitte ersetzen Sie diese URL durch Ihre eigene Google Apps Script URL,
    //          nachdem Sie das Skript bereitgestellt haben.
    // =================================================================================
    const googleScriptUrl = "IHRE_GOOGLE_APPS_SCRIPT_URL_HIER_EINFUEGEN";

    if (googleScriptUrl === "IHRE_GOOGLE_APPS_SCRIPT_URL_HIER_EINFUEGEN") {
      toast({
        title: "Konfiguration unvollständig",
        description: "Die Google Apps Script URL wurde noch nicht im Code hinterlegt.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      // We'll assume success if the fetch promise resolves and handle network errors in the catch block.
      toast({
  ...
  return (
    <div className="min-h-screen bg-acencia">
      ...
      {/* Contact Section - identischer Farbverlauf wie About Page */}
