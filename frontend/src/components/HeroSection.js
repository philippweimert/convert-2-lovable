...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.07]">
        ...
        <div className="absolute top-1/2 left-1/6 w-1.5 h-1.5 bg-orange-300 rounded-full animate-ping" style={{animationDelay: '1s'}}></div>
      </div>
